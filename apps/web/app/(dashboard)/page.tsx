                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                    ...
                    <div className="lg:col-span-2 space-y-6">
                        ...
                        <Card className="overflow-hidden border-none shadow-md hover:shadow-lg transition-shadow cursor-pointer">
                            <div className="h-80 bg-slate-200 bg-[url('https://images.unsplash.com/photo-1518546305927-5a555bb7020d?auto=format&fit=crop&q=80&w=1000')] bg-cover bg-center" />
                            <CardContent className="p-6 space-y-4">
                                <div className="flex items-center gap-3">
                                    <Badge className="bg-blue-100 text-blue-700 hover:bg-blue-100 border-none uppercase text-[10px]">Market Analysis</Badge>
                                    <span className="text-xs text-slate-400">2 hours ago</span>
                                </div>
                                <h3 className="text-2xl font-bold leading-tight hover:text-[#144bb8] transition-colors">
                                    Bitcoin hits new monthly high as institutional interest surges across global exchanges
                                </h3>
                                <p className="text-slate-600 line-clamp-2">
                                    Investors are flocking to digital assets as regulatory clarity improves in key markets...
                                </p>
                            </CardContent>
                        </Card>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <SecondaryNewsCard
                                category="Economy"
                                title="Federal Reserve hints at potential rate cuts in late Q3"
                                img="https://images.unsplash.com/photo-1611974717482-480051675c43?auto=format&fit=crop&q=80&w=500"
                            />
                            <SecondaryNewsCard
                                category="Tech"
                                title="New blockchain security protocol promises to eliminate vulnerabilities"
...
const SecondaryNewsCard = ({ category, title, img }: { category: string, title: string, img: string }) => (
